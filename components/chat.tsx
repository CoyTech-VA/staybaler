...
export function ChatProvider({children}:{children:React.ReactNode}) {
 ...
 const [messages,setMessages]=useState<{role:string;text:string;recommendations?:ChatResponse['recommendations']}[]>([{role:'assistant',text:"Hi! 👋 I'm Chat Agent Surfy. Welcome to StayBaler Beach Resort. Ask me about our rooms, amenities, and activities."}]);
